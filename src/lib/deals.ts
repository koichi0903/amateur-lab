...
export const dealCategories = {
  "ending-soon": {
    label: "終了間近",
    title: "FANZAでまもなく終了するセール",
    description: "終了予定が近いFANZAセール作品を、終了時刻の早い順に確認できます。",
  ...
  "lowest-price": {
    label: "過去最安",
    title: "FANZAで過去最安の作品",
    description: "取得済みの価格履歴と比べて、現在価格が最安水準のFANZA作品です。",
  ...
  "under-1000": {
    label: "1,000円以下",
    title: "1,000円以下で買えるFANZA作品",
    description: "代表価格が1,000円以下のFANZA作品を、価格の安い順に紹介します。",
  ...
  "high-rated": {
    label: "高評価セール",
    title: "レビュー高評価のFANZAセール作品",
    description: "レビュー件数があり、平均評価4.0以上のFANZAセール作品を厳選します。",
  ...
  "sample-available": {
    label: "サンプルあり",
    title: "サンプル動画を確認できるFANZA作品",
    description: "購入前に無料サンプル動画を確認できるFANZA作品を集めました。",
  ...
  "best-discount": {
    label: "割引率が高い",
    title: "割引率が高いFANZAセール作品",
    description: "現在セール中のFANZA作品を割引率の高い順に紹介します。",
