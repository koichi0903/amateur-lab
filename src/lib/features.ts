...
export const featureCategories = {
  beginners: {
    label: "はじめて選ぶ方へ",
    title: "初心者向け・失敗しにくいFANZA作品",
    description: "レビュー評価、件数、発掘スコア、無料サンプルの有無から、比較しやすいFANZA作品を選びました。",
  ...
  "under-500": {
    label: "ワンコイン",
    title: "500円以下で試せるFANZA作品",
    description: "代表価格が500円以下のFANZA作品を、評価と発掘スコアが高い順に紹介します。",
  ...
  "trusted-reviews": {
    label: "レビュー重視",
    title: "レビュー件数も多いFANZA高評価作品",
    description: "平均評価だけでなくレビュー件数も確認し、評価の根拠が比較的多いFANZA作品を紹介します。",
  ...
  "actress-discovery": {
    label: "女優から発掘",
    title: "出演女優から見つけるFANZAおすすめ作品",
    description: "女優情報が登録されたFANZA作品から、発掘スコアの高い新しい好みを探せます。",
  ...
  "hidden-gems": {
    label: "隠れた名作",
    title: "高評価のFANZA隠れた名作",
    description: "ランキング上位だけに偏らず、レビューと発掘スコアが高いFANZA作品を選びました。",
