...
if ((work.new_release_score ?? 0) >= 8) {
  ...
  return (
    <div
      className="border rounded-xl p-5 shadow hover:shadow-lg transition flex flex-col lg:flex-row gap-5"
    >
      <div
...
<div className="flex-1 flex flex-col">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr_auto] gap-6">
...
<div className="hidden lg:block mt-3 w-full text-[11px] text-gray-500 border-t pt-2 space-y-1">
