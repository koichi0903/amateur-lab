...
const configs = {
  maker: { label: "メーカー", plural: "社", eyebrow: "MAKER DISCOVERY", title: "メーカーから作品を発掘", description: "登録作品数と発掘スコアをもとに、注目のメーカーと高評価作品を探せます。", Icon: Building2 },
  series: { label: "シリーズ", plural: "件", eyebrow: "SERIES DISCOVERY", title: "シリーズから作品を発掘", description: "登録作品数と発掘スコアをもとに、人気シリーズと高評価作品を探せます。", Icon: Clapperboard },
  genre: { label: "ジャンル", plural: "件", eyebrow: "GENRE DISCOVERY", title: "ジャンルから作品を発掘", description: "登録作品数と発掘スコアをもとに、気になるジャンルと高評価作品を探せます。", Icon: Tags },
} as const;
